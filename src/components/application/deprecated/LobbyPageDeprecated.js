...
import LobbyJassTableDeprecated from "./LobbyJassTableDeprecated";
  ...
  return (
      <BackgroundContainer>
        <LobbyWrapper>
          ...
          <JassTeppichWrapper>
            <LobbyJassTableDeprecated client={stompClient} lobbyId={thisLobby.id}/>
          </JassTeppichWrapper>
          <ChatWrapper/>
...
export default LobbyPageDeprecated;