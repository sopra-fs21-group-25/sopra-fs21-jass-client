...
import {FloatingContainer} from "../../../views/design/ElegantAssets";
import flyingCards from '../../../views/images/interfaceImages/flying-cards.jpg';
...
class MenuDeprecated extends React.Component {
  constructor(props) {
    super(props);
...
export default withRouter(MenuDeprecated);