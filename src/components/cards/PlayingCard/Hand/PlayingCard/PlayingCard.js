...
class PlayingCard extends Component {
  ...
  static getDerivedStateFromProps(props, state) {
    ...
    if (prevProps.flipped !== props.flipped || prevProps.card !== props.card || prevProps.height !== props.height || prevProps.flippable !== props.flippable || prevProps.elevated !== props.elevated || prevProps.style !== props.style || prevProps.position !== props.position || prevProps.draggableDivStyle !== props.draggableDivStyle) {
      return {
